...
- Per‑server personalization (messages, emojis, etc.)
- Slash commands and modern Discord API usage
...
### User Install
Invite Veylora to your user profile for personal commands:  
...
### Server Install
Invite Veylora to your Discord server:  
